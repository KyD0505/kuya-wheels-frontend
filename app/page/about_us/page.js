    ...
    <div className="flex flex-wrap ">
      <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
        <div className="relative lg:max-w-md">
          <img src="/assets/proof4.jpg" alt="aboutimage" className="relative z-10 object-cover w-full rounded h-96" />
        </div>
      </div>
      <div className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
        ...
        <p className="mb-6 text-base leading-7 text-gray-500 dark:text-gray-400 text-justify md:text-normal">
    ...
    {/* <div className="pt-4 bg-white rounded shadow dark:bg-gray-900"> */}
      ...
      <div className="p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {certifications.map((certification, index) => (
          <div key={index} className="bg-gray-100 border-b-4 border-green-400 dark:bg-gray-800 p-4 rounded shadow">
         
            <h3 className="text-md mb-2 dark:text-gray-400">{certification.title}</h3>
