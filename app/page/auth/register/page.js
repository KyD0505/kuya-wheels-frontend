...
export default function Register(){
    return(
        <section className=" lg:flex lg:h-screen font-poppins  flex flex-col mx-auto dark:bg-gray-800">
        <div class="relative z-10 flex justify-center h-screen dark:bg-gray-800 2xl:py-44">
          <div
                              ...
                              <div class="p-6 shadow-md lg:p-9 bg-gray-50 dark:bg-gray-900 ">
                                  ...
                                  <form action="" class="p-0 m-0">
                                          ...
                                          <div>
                                              ...
                                              <div class="relative flex items-center mt-2">
                                                  ...
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                      class="absolute right-0 mr-3 dark:text-gray-50 bi bi-eye-slash"
                                      ...
                                      <div class="mt-5">
                                          <div>
                                              <label for=""
                                                  class="text-lg font-medium text-gray-700 dark:text-gray-400 ">Confirm Password:</label>
                                              <div class="relative flex items-center mt-2">
                                                  <input type="password"
                                                      class="w-full px-4 py-3 bg-gray-200 rounded-lg dark:text-gray-400 dark:bg-gray-800 "
                                                      name="" placeholder="Enter password" />
                      ...
                      <div class="ml-3 text-sm">
                        <label for="terms" class="font-light text-gray-500 dark:text-gray-300">I accept the <a class="font-medium text-blue-600 hover:underline dark:text-blue-500" href="#">Terms and Conditions</a></label>
                                      ...
                                      <div
                                          ...
                                          <Link href="/page/auth/login" class="ml-2 text-base font-semibold text-blue-700 dark:text-blue-300 dark:hover:text-blue-500">
                                             Login Here</Link>
                                      </div>
                                  </form>
                              </div>
