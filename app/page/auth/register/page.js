                ...
                <div class="flex flex-wrap items-center">
                  <div class="w-full px-4">
                    <div class="p-6 shadow-md lg:p-9 bg-gray-50">
                      <h2 class="mb-4 text-xl font-bold lg:mb-8 lg:text-3xl">Register an account</h2>
                      <form action="" class="p-0 m-0">
                        <div>
                          <label for="" class="text-lg font-medium text-gray-700">Email:</label>
                          <input type="email" class="w-full px-4 py-3 mt-3 bg-gray-200 rounded-lg" name="" placeholder="Enter your email" />
                        </div>
                        <div class="mt-5">
                          <div>
                            <label for="" class="text-lg font-medium text-gray-700">Password:</label>
                            <div class="relative flex items-center mt-2">
                              <input type="password" class="w-full px-4 py-3 bg-gray-200 rounded-lg" name="" placeholder="Enter password" />
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="absolute right-0 mr-3 bi bi-eye-slash" fill="currentColor" viewBox="0 0 16 16">
