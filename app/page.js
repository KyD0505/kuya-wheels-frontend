  ...
  return (
    <main className="flex h-fit flex-col items-center justify-between overflow-x-hidden " id="top-section">
      <section className="md:h-[90vh] h-fit w-screen md:p-12 p-4 flex flex-col md:flex-row justify-center gap-5" >
        <div className="card bg-white card-compact w-full md:w-[30vw] shadow-xl mb-5 md:mb-0">
          <div className="p-4 text-center flex flex-col justify-center items-center md:h-full">
            ...
            <div className="card-actions mt-3 justify-end">
              <button className="btn btn-primary" onClick={() => scrollToSection('google-map-section')}>Location</button>
              <button className="btn btn-secondary" onClick={() => scrollToSection('description-section')}>Learn more</button>
            </div>
          </div>
        </div>
        <Carousel />
      ...
      <section className="w-screen h-fit sm:h-[100vh] flex flex-col " id="google-map-section" >
        <header className=" py-4 bg-white text-center r">
          {/* <h1 className="md:text-3xl text-xl "></h1> */}
