...
export default function Home() {
  ...
  <main className="flex h-fit flex-col items-center justify-between overflow-x-hidden" id="top-section">
    <section className="relative md:flex h-fit w-screen xl:px-36 md:px-12 xl:py-24 py-12 p-4 flex flex-col md:flex-row justify-center gap-5">
      <section>
        <div className="absolute inset-0 bg-home-wheels bg-cover z-0"></div>
        <div class="absolute inset-0  bg-overlay-dark z-0"></div>
        <div class=" grid max-w-screen-xl py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          ...
          {/* <div class="hidden ml-5 lg:mt-0 lg:col-span-5 lg:flex width bg-cover">
            <img src="/assets/proof2.jpg" alt="mockup" />
          </div>                 */}
        </div>
      </section>
    </section>
    <section className="w-screen mt-5 h-fit sm:h-[100vh] flex flex-col text-gray-600" id="google-map-section">
        ...
        <div class="flex flex-wrap justify-center w-[40vw]">
          ...
          <div class="card card-compact lg:w-[30vw] bg-white md:w-[45vw] w-full">
            <div className="p-4 text-center">
              <h2 class="lg:text-2xl text-lg mb-3 font-bold">Office Hours</h2>
              <div className="flex flex-row justify-between px-8">
                <div className="flex flex-col justify-center items-start h-full">
                  <p class="lg:text-md text-md text-justify ">Monday</p>
                  <p class="lg:text-md text-md text-justify ">Tuesday</p>
                  <p class="lg:text-md text-md text-justify ">Wednesday</p>
                  <p class="lg:text-md text-md text-justify ">Thursday</p>
                  <p class="lg:text-md text-md text-justify ">Friday</p>
                  <p class="lg:text-md text-md text-justify ">Saturday</p>
                  <p class="lg:text-md text-md text-justify mb-10">Sunday</p>
                </div>
                <div class="flex flex-col justify-center items-center h-full">
                  <p class="lg:text-md text-md text-justify ">7:00am to 5:00pm</p>
                  <p class="lg:text-md text-md text-justify ">7:00am to 5:00pm</p>
                  <p class="lg:text-md text-md text-justify ">7:00am to 5:00pm</p>
                  <p class="lg:text-md text-md text-justify ">7:00am to 5:00pm</p>
                  <p class="lg:text-md text-md text-justify ">7:00am to 5:00pm</p>
                  <p class="lg:text-md text-md text-justify ">7:00am to 5:00pm</p>
                  <p class="lg:text-md text-md text-justify mb-10">No office</p>
                  {/* <div class="card-actions mt-2 justify-end">
                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Open in Google Maps</button>
                  </div> */}
                </div>
    ...
    <section className="h-fit sm:h-[100vh] w-screen flex flex-col" id="description-section">
      <hr className="mx-20 mt-20 mb-10"></hr>
      <header className="py-4 bg-white text-center r">
        <div class="divider divider-success">
          <h1 className="md:text-3xl text-xl text-gray-700">What we do</h1>
        </div>
      </header>
      <div className="flex flex-col sm:flex-row justify-center gap-8 md:p-12 p-4">
        <div class="max-w-lg rounded overflow-hidden shadow-lg">
          ...
          <div class="px-6 py-4">
            <div class="font-bold text-xl mb-2 text-gray-700 text-center">Education</div>
        ...
        <div class="max-w-lg rounded overflow-hidden shadow-lg">
          ...
          <div class="px-6 py-4">
            <div class="font-bold text-xl mb-2 text-gray-700 text-center">Assessment</div>
            <p class="text-gray-700 text-base">
